<template>
    <div style="padding-left:10px; padding-right: 10px; width: calc(100vw - 200px)">
        ...
        <el-table :data="tableData" border stripe style="width: 100%">
            ...
            <el-table-column prop="buyid" label="买家编号">
            </el-table-column>
            <el-table-column prop="sellid" label="卖家编号">
            </el-table-column>
            ...
            <el-dialog title="提示" v-model="dialogVisible" width="30%">
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="买家编号">
                        <el-input v-model="form.buyid"></el-input>
                    </el-form-item>
                    <el-form-item label="卖家编号">
                        <el-input v-model="form.sellid"></el-input>
                    </el-form-item>
                    <el-form-item label="订单编号">
                    ...
                    <el-form-item label="订单时间">
                        <el-date-picker style="width: 100%;" value-format="YYYY-MM-DD HH:mm:ss" v-model="form.orderdate"
    ...
    methods: {
        ...
        save() {
            ...
            if (this.form.goodsid) {//更新
                request.post("/api/order/update", this.form).then(res => {
                    console.log(res);
                    if (res.state == '0') {
                        this.$message({
                            type: "success",
        ...
        handleDelete(id) {
            console.log(id);
            request.get("/api/order/delete?id=" + id).then(res => {
                console.log(res)
                if (res.state === '0') {
                    this.$message({
                        type: "success",
